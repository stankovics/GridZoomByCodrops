 ...
 */ const getScrollValues = ()=>{
    ...
    const y = supportPageOffset ? window.pageYOffset : isCSS1Compat ? document.documentElement.scrollLeft : document.body.scrollLeft;
    return y;
};
/** wrapLines
...
},{"./contentitem":"hJqOS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hJqOS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class TextLinesReveal {
    ...
    constructor(animationElems){
        ...
        for (const el of this.DOM.animationElems){
            ...
            _utils.wrapLines(SplitTypeInstance.lines, 'div', 'oh'); // 1. creates new div, 2. adds to div class of '.oh', 3. append created div as last child of lines parent element, 4. append each word as last child in new div with class of .oh
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l4AUa","ebWYT"], "ebWYT", "parcelRequire0ca2")
